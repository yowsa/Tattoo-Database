function front_page(items) {
    ...
    var front_lettering = $('<div />', { id: 'front-lettering', class: 'd-flex flex-column justify-content-around align-items-center text-center' }).html('<p class="front-lettering-1">Aa 123</p><p class="front-lettering-2">Aa 123</p><p class="front-lettering-3">Aa 123</p><p class="front-lettering-4">Aa 123</p><p class="front-lettering-6">Aa 123</p><p class="front-lettering-5">BLAEK <br/> <span>FONT FINDER</span></p~').appendTo('#search-images-col-3')
